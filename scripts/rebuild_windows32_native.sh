...
# Build tsMuxer for Windows 32-bit with Qt6 and Windows 7 compatibility
...
echo "Downloading Qt6 Windows 7 compatible binaries (32-bit)..."
QT_URL="https://github.com/crystalidea/qt6windows7/releases/download/${QT_VERSION}/qt-${QT_VERSION}-win32-msvc2022-static.zip"
...
echo "Build complete: bin/tsMuxeR.exe (32-bit)"
if [ -f bin/tsMuxerGUI.exe ]; then
  echo "GUI build complete: bin/tsMuxerGUI.exe (32-bit)"
fi
